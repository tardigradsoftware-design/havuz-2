...
Browser automation: driving a real browser from code or from an agent — selector strategy, waiting, flake control, and what an agent can reliably do versus what needs a human.
...
- [`skills/browser-testing/SKILL.md`](../../skills/browser-testing/SKILL.md)
