...
General coding knowledge that is not tied to one language or framework: naming, error handling, boundaries, and the decisions that recur in every codebase.
