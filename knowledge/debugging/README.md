...
Debugging: how to move from a symptom to a cause without guessing — reproduction, bisection, instrumentation, and the difference between a fix and an explanation.
