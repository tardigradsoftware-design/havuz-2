...
Context engineering: what goes into a model window, in what order, and what gets dropped — the discipline that decides whether an agent stays coherent over a long task.
