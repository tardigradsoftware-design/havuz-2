...
Motion: what animation is for in an interface, how long a transition should take, and when movement communicates rather than decorates.
...
- [`skills/motion-design/SKILL.md`](../../skills/motion-design/SKILL.md)
