---
id: mcp-korotovsky-slack-mcp-server
...
sources:
  - title: "korotovsky/slack-mcp-server — GitHub repository metadata"
    url: https://github.com/korotovsky/slack-mcp-server
...
| Stars | 1,829 (checked 2026-09-16) |
| License | `MIT` |
| Archived | no |
| Last push | 2026-07-16T17:14:22Z (60 days ago) |
| Language | Go |
...
As stated by the repository itself: "The most powerful MCP Slack Server with no permission requirements, Apps support, GovSlack, DMs, Group DMs and smart history fetch logic."
