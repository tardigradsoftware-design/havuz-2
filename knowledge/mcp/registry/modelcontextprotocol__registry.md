---
id: mcp-modelcontextprotocol-registry
name: registry
purpose: >-
...
sources:
  - title: "modelcontextprotocol/registry — GitHub repository metadata"
    url: https://github.com/modelcontextprotocol/registry
...
| Stars | 7,250 (checked 2026-09-16) |
| License | `NOASSERTION` — **no SPDX-recognised license; do not redistribute** |
| Archived | no |
| Last push | 2026-09-09T23:33:38Z (5 days ago) |
| Language | Go |
...
As stated by the repository itself: "A community driven registry service for Model Context Protocol (MCP) servers."
