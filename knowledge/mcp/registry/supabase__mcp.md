...
name: mcp
purpose: >-
  As stated by the repository itself: "Connect Supabase to your AI assistants"
category: database
category_evidence: topics-or-slug
category_signals: ["supabase"]
registry_kind: server
registry_kind_evidence: >-
  slug "supabase/mcp" names the repository as MCP
distribution: source
official: true
maintainer: supabase
...
days_since_push: 0
language: TypeScript
tags: ["database", "mcp", "supabase"]
verified_at: 2026-09-16
expires_at: 2026-12-15
sources:
  - title: "supabase/mcp — GitHub repository metadata"
    url: https://github.com/supabase/mcp
...
`supabase/mcp` — As stated by the repository itself: "Connect Supabase to your AI assistants"

**Registry kind: `server`.** Counted as an MCP server in `indexes/mcp.md` and in the README statistics. This is what the registry's consumers — `skills/mcp-integration` and `skills/dont-reinvent-the-wheel` — mean when they say consult the registry before installing a server. Evidence: slug "supabase/mcp" names the repository as MCP.
...
| Stars | 2,908 (checked 2026-09-16) |
| License | `Apache-2.0` |
| Archived | no |
| Last push | 2026-09-15T13:17:59Z (0 days ago) |
| Language | TypeScript |
| Latest release | mcp-server-supabase-v0.12.0 |
| Contributors | 24 |
| SECURITY.md published | **no** |
| Tests present | **no** |
| CI present | yes |
| Tier / quality score | S / 8.07 |
