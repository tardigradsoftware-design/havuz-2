...
sources:
  - title: "stripe/ai — GitHub repository metadata"
    url: https://github.com/stripe/ai
...
| Field | Value |
|---|---|
| Repository | [`stripe/ai`](https://github.com/stripe/ai) |
| Stars | 1,816 (checked 2026-09-16) |
| License | `MIT` |
| Archived | no |
| Last push | 2026-09-15T00:50:10Z (0 days ago) |
| Language | TypeScript |
...
As stated by the repository itself: "One-stop shop for building AI-powered products and businesses with Stripe."
