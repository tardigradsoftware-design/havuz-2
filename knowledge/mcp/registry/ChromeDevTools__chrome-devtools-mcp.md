---
id: mcp-chromedevtools-chrome-devtools-mcp
...
sources:
  - title: "ChromeDevTools/chrome-devtools-mcp — GitHub repository metadata"
    url: https://github.com/ChromeDevTools/chrome-devtools-mcp
...
| Stars | 52,038 (checked 2026-09-16) |
| License | `Apache-2.0` |
| Archived | no |
| Last push | 2026-09-15T14:36:29Z (0 days ago) |
| Language | TypeScript |
| Latest release | chrome-devtools-mcp-v1.9.0 |
| Contributors | 127 |
| SECURITY.md published | yes |
| Tests present | yes |
| CI present | yes |
| Tier / quality score | S / 8.15 |
