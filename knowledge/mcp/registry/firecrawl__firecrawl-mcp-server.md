---
id: mcp-firecrawl-firecrawl-mcp-server
...
sources:
  - title: "firecrawl/firecrawl-mcp-server — GitHub repository metadata"
    url: https://github.com/firecrawl/firecrawl-mcp-server
...
| Stars | 7,458 (checked 2026-09-16) |
| License | `MIT` |
| Archived | no |
| Last push | 2026-09-14T03:01:19Z (1 days ago) |
| Language | JavaScript |
...
As stated by the repository itself: "🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients."
