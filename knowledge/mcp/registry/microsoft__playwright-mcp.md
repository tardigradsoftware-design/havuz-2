...
name: playwright-mcp
purpose: >-
  As stated by the repository itself: "Playwright MCP server"
category: browser
category_evidence: topics-or-slug
category_signals: ["playwright"]
...
days_since_push: 0
language: TypeScript
tags: ["automation", "browser", "mcp", "playwright"]
verified_at: 2026-09-16
expires_at: 2026-12-15
sources:
  - title: "microsoft/playwright-mcp — GitHub repository metadata"
    url: https://github.com/microsoft/playwright-mcp
...
`microsoft/playwright-mcp` — As stated by the repository itself: "Playwright MCP server"
...
| Stars | 37,137 (checked 2026-09-16) |
| License | `Apache-2.0` |
| Archived | no |
| Last push | 2026-09-14T21:24:01Z (0 days ago) |
| Language | TypeScript |
| Latest release | v0.0.81 |
| Contributors | 70 |
| SECURITY.md published | yes |
| Tests present | yes |
| CI present | yes |
| Tier / quality score | S / 8.9 |
