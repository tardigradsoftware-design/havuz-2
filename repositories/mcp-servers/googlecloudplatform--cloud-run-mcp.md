...
summary: >-
  ...
  631 stars, license Apache-2.0, quality 7.41/10, trust 6.19/10.
...
scoring:
  components: {"authority": 5.0, "maintenance": 8.5, "adoption": 9.56, "documentation": 5.11, "reproducibility": 9.5, "security": 6.0, "recency": 9.89, "evidence": 6.5}
  quality_score: 7.41
  trust_score: 6.19
  tier: A
...
| Language | JavaScript |
| License | `Apache-2.0` |
| Stars | 631 (checked 2026-09-21) |
| Forks | 122 |
| Open issues | 24 |
| Contributors | 14 |
| Last push | 2026-09-13 (8 days before verification) |
