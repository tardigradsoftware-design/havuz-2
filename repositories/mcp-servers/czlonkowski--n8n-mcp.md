...
sources:
  - title: "czlonkowski/n8n-mcp on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug czlonkowski/n8n-mcp
