...
summary: >-
  ...
  7,268 stars, license NOASSERTION, quality 8.62/10, trust 8.53/10.
...
scoring:
  components: {"authority": 8.5, "maintenance": 10.0, "adoption": 10.0, "documentation": 7.18, "reproducibility": 8.6, "security": 6.5, "recency": 9.95, "evidence": 7.0}
  quality_score: 8.62
  trust_score: 8.53
  tier: A
...
| Language | Go |
| License | `NOASSERTION` |
| Stars | 7,268 (checked 2026-09-21) |
| Forks | 995 |
| Open issues | 163 |
| Contributors | 73 |
