...
summary: >-
  ...
  2,382 stars, license MIT, quality 7.17/10, trust 6.48/10.
...
scoring:
  components: {"authority": 8.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 4.23, "reproducibility": 5.0, "security": 4.5, "recency": 9.95, "evidence": 2.0}
  quality_score: 7.17
  trust_score: 6.48
  tier: A
...
| Language | TypeScript |
| License | `MIT` |
| Stars | 2,382 (checked 2026-09-15) |
| Forks | 299 |
| Open issues | 57 |
| Contributors | 16 |
