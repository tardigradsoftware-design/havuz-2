...
summary: >-
  ...
  5,926 stars, license MIT, quality 8.54/10, trust 8.24/10.
...
scoring:
  components: {"authority": 7.5, "maintenance": 10.0, "adoption": 10.0, "documentation": 6.93, "reproducibility": 9.5, "security": 7.0, "recency": 9.99, "evidence": 7.0}
  quality_score: 8.54
  trust_score: 8.24
  tier: S
...
| Language | Python |
| License | `MIT` |
| Stars | 5,926 (checked 2026-09-21) |
| Forks | 1,364 |
| Open issues | 234 |
| Contributors | 182 |
...
| Archived | no |
| Fork | no |
| Homepage | [https://mcp-atlassian.soomiles.com](https://mcp-atlassian.soomiles.com) |
