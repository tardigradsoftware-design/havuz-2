...
title: "makenotion/notion-mcp-server"
domain: mcp-servers
summary: >-
...
sources:
  - title: "makenotion/notion-mcp-server on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug makenotion/notion-mcp-server
