...
sources:
  - title: "openai/openai-agents-python on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug openai/openai-agents-python
