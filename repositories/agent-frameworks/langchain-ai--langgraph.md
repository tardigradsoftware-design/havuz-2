...
summary: >-
  ...
  42,060 stars, license MIT, quality 8.35/10, trust 8.13/10.
...
| Language | Python |
| License | `MIT` |
| Stars | 42,060 (checked 2026-09-21) |
| Forks | 7,102 |
| Open issues | 809 |
| Contributors | 279 |
...
| Archived | no |
| Fork | no |
| Homepage | [https://docs.langchain.com/oss/python/langgraph/](https://docs.langchain.com/oss/python/langgraph/) |
