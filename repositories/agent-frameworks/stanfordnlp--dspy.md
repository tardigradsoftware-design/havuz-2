...
sources:
  - title: "stanfordnlp/dspy on GitHub"
...
|---|---|
| URL | <https://github.com/stanfordnlp/dspy> |
| Owner | stanfordnlp (Organization) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug stanfordnlp/dspy
