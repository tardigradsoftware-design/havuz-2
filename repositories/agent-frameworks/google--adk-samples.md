...
summary: >-
  google/adk-samples — ACTIVE, tier A,
  10,315 stars, license Apache-2.0, quality 7.82/10, trust 7.51/10.
...
scoring:
  components: {"authority": 8.5, "maintenance": 10.0, "adoption": 10.0, "documentation": 6.71, "reproducibility": 6.0, "security": 4.5, "recency": 10.0, "evidence": 4.0}
  quality_score: 7.82
  trust_score: 7.51
  tier: A
...
sources:
  - title: "google/adk-samples on GitHub"
...
| Language | Python |
| License | `Apache-2.0` |
| Stars | 10,315 (checked 2026-09-15) |
| Forks | 2,863 |
| Open issues | 77 |
| Contributors | 133 |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug google/adk-samples
