...
summary: >-
  ...
  7,955 stars, license MIT, quality 7.55/10, trust 6.55/10.
...
scoring:
  components: {"authority": 6.0, "maintenance": 7.5, "adoption": 10.0, "documentation": 5.99, "reproducibility": 9.5, "security": 6.0, "recency": 8.78, "evidence": 7.0}
  quality_score: 7.55
  trust_score: 6.55
  tier: A
...
| Language | Python |
| License | `MIT` |
| Stars | 7,955 (checked 2026-09-15) |
| Forks | 744 |
| Open issues | 33 |
| Contributors | 39 |
| Last push | 2026-06-18 (89 days before verification) |
