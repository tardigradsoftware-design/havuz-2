...
- [ggml-org/llama.cpp](./ggml-org--llama.cpp.md) — tier S, ACTIVE
- [google-gemini/cookbook](./google-gemini--cookbook.md) — tier A, ACTIVE
- [huggingface/datasets](./huggingface--datasets.md) — tier S, STABLE
- [huggingface/peft](./huggingface--peft.md) — tier S, ACTIVE
- [huggingface/text-generation-inference](./huggingface--text-generation-inference.md) — tier ARCHIVED, ARCHIVED
- [huggingface/transformers](./huggingface--transformers.md) — tier S, ACTIVE
- [huggingface/trl](./huggingface--trl.md) — tier S, ACTIVE
- [microsoft/generative-ai-for-beginners](./microsoft--generative-ai-for-beginners.md) — tier S, ACTIVE
- [Mintplex-Labs/anything-llm](./mintplex-labs--anything-llm.md) — tier A, ACTIVE
- [ml-explore/mlx](./ml-explore--mlx.md) — tier S, ACTIVE
- [mlabonne/llm-course](./mlabonne--llm-course.md) — tier B, MAINTENANCE
- [ollama/ollama](./ollama--ollama.md) — tier S, ACTIVE
