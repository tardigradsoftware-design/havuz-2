...
sources:
  - title: "dair-ai/Prompt-Engineering-Guide on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug dair-ai/Prompt-Engineering-Guide
