...
sources:
  - title: "anthropics/prompt-eng-interactive-tutorial on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug anthropics/prompt-eng-interactive-tutorial
