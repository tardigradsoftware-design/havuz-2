...
sources:
  - title: "Mintplex-Labs/anything-llm on GitHub"
...
|---|---|
| URL | <https://github.com/Mintplex-Labs/anything-llm> |
| Owner | Mintplex-Labs (Organization) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug Mintplex-Labs/anything-llm
