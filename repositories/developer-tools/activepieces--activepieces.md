...
sources:
  - title: "activepieces/activepieces on GitHub"
    url: https://github.com/activepieces/activepieces
    type: github-repository
    organization: activepieces
    license: NOASSERTION
    confidence: high
    claim_type: fact
    verified_at: 2026-09-15
...
|---|---|
| URL | <https://github.com/activepieces/activepieces> |
| Owner | activepieces (Organization) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug activepieces/activepieces
