...
sources:
  - title: "GoogleChrome/lighthouse on GitHub"
...
|---|---|
| URL | <https://github.com/GoogleChrome/lighthouse> |
| Owner | GoogleChrome (Organization) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug GoogleChrome/lighthouse
