...
summary: >-
  ...
  2,499 stars, license NOASSERTION, quality 7.88/10, trust 7.78/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 9.0, "adoption": 10.0, "documentation": 7.51, "reproducibility": 6.1, "security": 4.0, "recency": 9.67, "evidence": 5.0}
  quality_score: 7.88
  trust_score: 7.78
  tier: A
...
| Language | Markdown |
| License | `NOASSERTION` |
| Stars | 2,499 (checked 2026-09-21) |
| Forks | 470 |
| Open issues | 28 |
| Contributors | 30 |
...
| Archived | no |
| Fork | no |
| Homepage | [https://adr.github.io/madr/](https://adr.github.io/madr/) |
