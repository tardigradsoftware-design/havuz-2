...
sources:
  - title: "artilleryio/artillery on GitHub"
...
|---|---|
| URL | <https://github.com/artilleryio/artillery> |
| Owner | artilleryio (Organization) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug artilleryio/artillery
