...
sources:
  - title: "Panniantong/Agent-Reach on GitHub"
    url: https://github.com/Panniantong/Agent-Reach
    type: github-repository
    organization: Panniantong
    license: MIT
    license_risk: none
    confidence: high
    claim_type: fact
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug Panniantong/Agent-Reach
