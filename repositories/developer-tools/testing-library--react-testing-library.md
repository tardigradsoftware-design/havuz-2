...
sources:
  - title: "testing-library/react-testing-library on GitHub"
...
|---|---|
| URL | <https://github.com/testing-library/react-testing-library> |
| Owner | testing-library (Organization) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug testing-library/react-testing-library
