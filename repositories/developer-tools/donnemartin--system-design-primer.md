...
sources:
  - title: "donnemartin/system-design-primer on GitHub"
    url: https://github.com/donnemartin/system-design-primer
    type: github-repository
    organization: donnemartin
    license: NOASSERTION
    confidence: high
    claim_type: fact
    verified_at: 2026-09-15
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug donnemartin/system-design-primer
