...
sources:
  - title: "mermaid-js/mermaid on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug mermaid-js/mermaid
