...
summary: >-
  ...
  7,879 stars, license Apache-2.0, quality 8.18/10, trust 7.93/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 6.84, "reproducibility": 7.5, "security": 4.5, "recency": 10.0, "evidence": 5.0}
  quality_score: 8.18
  trust_score: 7.93
  tier: S
...
| Language | Go |
| License | `Apache-2.0` |
| Stars | 7,879 (checked 2026-09-15) |
| Forks | 676 |
| Open issues | 373 |
| Contributors | 410 |
