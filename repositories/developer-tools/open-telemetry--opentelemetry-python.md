---
id: open-telemetry--opentelemetry-python
...
sources:
  - title: "open-telemetry/opentelemetry-python on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug open-telemetry/opentelemetry-python
