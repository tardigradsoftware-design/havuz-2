...
sources:
  - title: "Graphify-Labs/graphify on GitHub"
...
|---|---|
| URL | <https://github.com/Graphify-Labs/graphify> |
| Owner | Graphify-Labs (Organization) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug Graphify-Labs/graphify
