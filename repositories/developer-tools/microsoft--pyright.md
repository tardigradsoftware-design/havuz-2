...
title: "microsoft/pyright"
domain: developer-tools
summary: >-
  microsoft/pyright — ACTIVE, tier A,
  15,644 stars, license NOASSERTION, quality 7.89/10, trust 7.55/10.
...
scoring:
  components: {"authority": 8.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 5.8, "reproducibility": 6.1, "security": 6.5, "recency": 10.0, "evidence": 4.5}
  quality_score: 7.89
  trust_score: 7.55
  tier: A
...
sources:
  - title: "microsoft/pyright on GitHub"
...
| Language | Python |
| License | `NOASSERTION` |
| Stars | 15,644 (checked 2026-09-15) |
| Forks | 1,815 |
| Open issues | 337 |
| Contributors | 152 |
| Last push | 2026-09-15 (0 days before verification) |
| Latest release | 1.1.414 (2026-09-09) |
| Archived | no |
| Fork | no |
| Homepage | — |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug microsoft/pyright
