...
sources:
  - title: "BurntSushi/ripgrep on GitHub"
    url: https://github.com/BurntSushi/ripgrep
    type: github-repository
    organization: BurntSushi
    license: Unlicense
    confidence: very-high
    claim_type: fact
    verified_at: 2026-09-15
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug BurntSushi/ripgrep
