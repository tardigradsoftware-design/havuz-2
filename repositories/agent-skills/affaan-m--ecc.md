...
domain: agent-skills
summary: >-
  affaan-m/ECC — ACTIVE, tier S,
  264,240 stars, license MIT, quality 8.45/10, trust 7.72/10.
  Verified against the GitHub API on 2026-09-21.
status: active
confidence: very-high
claim_type: fact
evidence_level: verified-github-api
tags: ["agent", "agent-skills", "github-repository", "harness", "optimization"]
version: 1.0.0
updated: 2026-09-21
...
| Language | JavaScript |
| License | `MIT` |
| Stars | 264,240 (checked 2026-09-21) |
| Forks | 39,504 |
| Open issues | 213 |
| Contributors | 351 |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug affaan-m/ECC
