...
sources:
  - title: "K-Dense-AI/scientific-agent-skills on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug K-Dense-AI/scientific-agent-skills
