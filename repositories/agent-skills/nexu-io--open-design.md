...
sources:
  - title: "nexu-io/open-design on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug nexu-io/open-design
