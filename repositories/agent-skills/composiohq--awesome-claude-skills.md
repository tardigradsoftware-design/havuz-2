...
domain: agent-skills
summary: >-
  ComposioHQ/awesome-claude-skills — ACTIVE, tier NO-LICENSE,
  75,421 stars, license NONE, quality 6.6/10, trust 4.35/10.
  Verified against the GitHub API on 2026-09-21.
status: active
confidence: medium
claim_type: fact
evidence_level: verified-github-api
tags: ["agent-skills", "catalog", "discovery", "github-repository"]
version: 1.0.0
updated: 2026-09-21
verified_at: 2026-09-21
expires_at: 2026-11-05
scoring:
  components: {"authority": 5.5, "maintenance": 10.0, "adoption": 10.0, "documentation": 7.0, "reproducibility": 2.5, "security": 1.5, "recency": 9.96, "evidence": 4.0}
  quality_score: 6.6
  trust_score: 4.35
  tier: NO-LICENSE
  maturity: early
...
sources:
  - title: "ComposioHQ/awesome-claude-skills on GitHub"
...
|---|---|
| URL | <https://github.com/ComposioHQ/awesome-claude-skills> |
| Owner | ComposioHQ (Organization) |
| Official upstream | no |
| Language | Python |
| License | `NONE` |
| Stars | 75,421 (checked 2026-09-21) |
| Forks | 8,738 |
| Open issues | 1,491 |
| Contributors | 28 |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug ComposioHQ/awesome-claude-skills
