...
sources:
  - title: "taskforcesh/bullmq on GitHub"
...
|---|---|
| URL | <https://github.com/taskforcesh/bullmq> |
| Owner | taskforcesh (Organization) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug taskforcesh/bullmq
