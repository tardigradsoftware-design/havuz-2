...
summary: >-
  ...
  40,608 stars, license MIT, quality 8.52/10, trust 8.32/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 6.15, "reproducibility": 8.0, "security": 7.0, "recency": 10.0, "evidence": 6.0}
  quality_score: 8.52
  trust_score: 8.32
  tier: S
...
| Language | TypeScript |
| License | `MIT` |
| Stars | 40,608 (checked 2026-09-15) |
| Forks | 1,671 |
| Open issues | 195 |
| Contributors | 460 |
