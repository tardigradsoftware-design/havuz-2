...
summary: >-
  ...
  2,567 stars, license MIT, quality 8.55/10, trust 8.52/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 10.0, "reproducibility": 7.5, "security": 4.5, "recency": 9.97, "evidence": 5.5}
  quality_score: 8.55
  trust_score: 8.52
  tier: S
...
| Language | Go |
| License | `MIT` |
| Stars | 2,567 (checked 2026-09-21) |
| Forks | 763 |
| Open issues | 351 |
| Contributors | 134 |
