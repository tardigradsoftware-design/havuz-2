...
summary: >-
  ...
  20,398 stars, license Apache-2.0, quality 8.48/10, trust 8.34/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 7.92, "reproducibility": 8.5, "security": 4.5, "recency": 9.86, "evidence": 6.0}
  quality_score: 8.48
  trust_score: 8.34
  tier: S
...
| Language | Go |
| License | `Apache-2.0` |
| Stars | 20,398 (checked 2026-09-21) |
| Forks | 1,756 |
| Open issues | 38 |
| Contributors | 155 |
