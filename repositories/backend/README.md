...
- [apache/casbin](./apache--casbin.md) — tier S, ACTIVE
- [better-auth/better-auth](./better-auth--better-auth.md) — tier S, ACTIVE
- [denoland/deno](./denoland--deno.md) — tier S, ACTIVE
- [expressjs/express](./expressjs--express.md) — tier S, ACTIVE
- [fastapi/fastapi](./fastapi--fastapi.md) — tier S, ACTIVE
- [fastapi/full-stack-fastapi-template](./fastapi--full-stack-fastapi-template.md) — tier A, ACTIVE
- [graphql/graphql-spec](./graphql--graphql-spec.md) — tier A, ACTIVE
- [honojs/hono](./honojs--hono.md) — tier S, ACTIVE
- [keycloak/keycloak](./keycloak--keycloak.md) — tier S, ACTIVE
- [lucia-auth/lucia](./lucia-auth--lucia.md) — tier A, STABLE
- [nats-io/nats-server](./nats-io--nats-server.md) — tier S, ACTIVE
- [nestjs/nest](./nestjs--nest.md) — tier S, ACTIVE
- [nodejs/node](./nodejs--node.md) — tier A, ACTIVE
- [openfga/openfga](./openfga--openfga.md) — tier S, ACTIVE
- [ory/kratos](./ory--kratos.md) — tier S, STABLE
- [oven-sh/bun](./oven-sh--bun.md) — tier A, ACTIVE
- [Permify/permify](./permify--permify.md) — tier S, ACTIVE
- [supabase/auth](./supabase--auth.md) — tier S, ACTIVE
- [taskforcesh/bullmq](./taskforcesh--bullmq.md) — tier S, ACTIVE
- [temporalio/temporal](./temporalio--temporal.md) — tier S, ACTIVE
- [trpc/trpc](./trpc--trpc.md) — tier S, ACTIVE
