...
summary: >-
  ...
  102,348 stars, license MIT, quality 8.69/10, trust 8.71/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 7.9, "reproducibility": 9.0, "security": 4.5, "recency": 10.0, "evidence": 7.5}
  quality_score: 8.69
  trust_score: 8.71
  tier: S
...
| Language | Python |
| License | `MIT` |
| Stars | 102,348 (checked 2026-09-15) |
| Forks | 9,885 |
| Open issues | 77 |
| Contributors | 457 |
