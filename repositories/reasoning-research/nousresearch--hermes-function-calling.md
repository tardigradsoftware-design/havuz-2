---
id: nousresearch--hermes-function-calling
...
sources:
  - title: "NousResearch/Hermes-Function-Calling on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug NousResearch/Hermes-Function-Calling
