---
id: os-agent-survey--os-agent-survey
...
sources:
  - title: "OS-Agent-Survey/OS-Agent-Survey on GitHub"
    url: https://github.com/OS-Agent-Survey/OS-Agent-Survey
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug OS-Agent-Survey/OS-Agent-Survey
