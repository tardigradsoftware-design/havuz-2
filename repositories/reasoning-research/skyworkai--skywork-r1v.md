...
summary: >-
  ...
  3,171 stars, license MIT, quality 6.24/10, trust 4.95/10.
...
scoring:
  components: {"authority": 6.0, "maintenance": 7.0, "adoption": 10.0, "documentation": 5.17, "reproducibility": 4.5, "security": 3.5, "recency": 9.26, "evidence": 2.5}
  quality_score: 6.24
  trust_score: 4.95
  tier: B
...
| Language | Python |
| License | `MIT` |
| Stars | 3,171 (checked 2026-09-21) |
| Forks | 282 |
| Open issues | 36 |
| Contributors | 11 |
