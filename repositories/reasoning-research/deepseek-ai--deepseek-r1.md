...
summary: >-
  ...
  91,980 stars, license MIT, quality 5.65/10, trust 5.41/10.
...
scoring:
  components: {"authority": 8.0, "maintenance": 1.0, "adoption": 10.0, "documentation": 4.73, "reproducibility": 7.0, "security": 3.5, "recency": 3.82, "evidence": 5.0}
  quality_score: 5.65
  trust_score: 5.41
  tier: C
...
| Language | — |
| License | `MIT` |
| Stars | 91,980 (checked 2026-09-21) |
| Forks | 11,681 |
| Open issues | 35 |
| Contributors | 12 |
| Last push | 2025-06-27 (451 days before verification) |
