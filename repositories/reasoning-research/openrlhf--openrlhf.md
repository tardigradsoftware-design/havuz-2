...
summary: >-
  ...
  10,005 stars, license Apache-2.0, quality 9.05/10, trust 9.2/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 9.5, "reproducibility": 10.0, "security": 4.5, "recency": 9.99, "evidence": 8.5}
  quality_score: 9.05
  trust_score: 9.2
  tier: S
...
| Language | Python |
| License | `Apache-2.0` |
| Stars | 10,005 (checked 2026-09-15) |
| Forks | 1,018 |
| Open issues | 380 |
| Contributors | 94 |
