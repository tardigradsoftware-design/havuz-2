...
summary: >-
  ...
  67,327 stars, license Apache-2.0, quality 8.38/10, trust 8.2/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 5.35, "reproducibility": 9.0, "security": 4.5, "recency": 9.99, "evidence": 7.0}
  quality_score: 8.38
  trust_score: 8.2
  tier: S
...
| Language | TypeScript |
| License | `Apache-2.0` |
| Stars | 67,327 (checked 2026-09-15) |
| Forks | 19,821 |
| Open issues | 1,501 |
| Contributors | 274 |
