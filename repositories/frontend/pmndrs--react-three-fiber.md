...
sources:
  - title: "pmndrs/react-three-fiber on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug pmndrs/react-three-fiber
