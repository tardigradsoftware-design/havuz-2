...
sources:
  - title: "tailwindlabs/headlessui on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug tailwindlabs/headlessui
