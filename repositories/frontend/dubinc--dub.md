...
domain: frontend
summary: >-
  dubinc/dub — ACTIVE, tier A,
  24,745 stars, license NOASSERTION, quality 7.85/10, trust 7.59/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 4.91, "reproducibility": 5.1, "security": 6.5, "recency": 10.0, "evidence": 4.0}
  quality_score: 7.85
  trust_score: 7.59
  tier: A
...
|---|---|
| URL | <https://github.com/dubinc/dub> |
| Owner | dubinc (Organization) |
| Official upstream | yes |
| Language | TypeScript |
| License | `NOASSERTION` |
| Stars | 24,745 (checked 2026-09-15) |
| Forks | 3,288 |
| Open issues | 146 |
| Contributors | 88 |
...
| Archived | no |
| Fork | no |
| Homepage | [https://dub.co](https://dub.co) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug dubinc/dub
