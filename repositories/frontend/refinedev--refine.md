...
sources:
  - title: "refinedev/refine on GitHub"
    url: https://github.com/refinedev/refine
    type: github-repository
    organization: refinedev
    license: MIT
    license_risk: none
    confidence: very-high
    claim_type: fact
...
| Archived | no |
| Fork | no |
| Homepage | [https://refine.dev](https://refine.dev) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug refinedev/refine
