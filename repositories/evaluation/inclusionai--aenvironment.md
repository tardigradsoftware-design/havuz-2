...
summary: >-
  ...
  315 stars, license Apache-2.0, quality 6.66/10, trust 5.68/10.
...
scoring:
  components: {"authority": 6.0, "maintenance": 7.0, "adoption": 8.63, "documentation": 7.54, "reproducibility": 7.0, "security": 3.5, "recency": 9.08, "evidence": 4.0}
  quality_score: 6.66
  trust_score: 5.68
  tier: B
...
| Language | Python |
| License | `Apache-2.0` |
| Stars | 315 (checked 2026-09-15) |
| Forks | 37 |
| Open issues | 14 |
| Contributors | 6 |
| Last push | 2026-07-10 (67 days before verification) |
