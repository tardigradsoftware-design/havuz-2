...
sources:
  - title: "OWASP/API-Security on GitHub"
...
| Archived | no |
| Fork | no |
| Homepage | [https://owasp.org/www-project-api-security/](https://owasp.org/www-project-api-security/) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug OWASP/API-Security
