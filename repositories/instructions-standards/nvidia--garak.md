...
summary: >-
  ...
  9,321 stars, license Apache-2.0, quality 8.96/10, trust 9.0/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 8.18, "reproducibility": 9.0, "security": 7.0, "recency": 9.95, "evidence": 7.5}
  quality_score: 8.96
  trust_score: 9.0
  tier: S
...
| Language | Python |
| License | `Apache-2.0` |
| Stars | 9,321 (checked 2026-09-21) |
| Forks | 1,295 |
| Open issues | 451 |
| Contributors | 130 |
