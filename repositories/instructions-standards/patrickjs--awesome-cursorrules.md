...
sources:
  - title: "PatrickJS/awesome-cursorrules on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug PatrickJS/awesome-cursorrules
