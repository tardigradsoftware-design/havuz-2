...
summary: >-
  ...
  1,447 stars, license NONE, quality 5.03/10, trust 3.2/10.
...
scoring:
  components: {"authority": 8.0, "maintenance": 3.0, "adoption": 10.0, "documentation": 3.0, "reproducibility": 1.0, "security": 2.5, "recency": 6.3, "evidence": 2.0}
  quality_score: 5.03
  trust_score: 3.2
  tier: NO-LICENSE
...
| Language | HTML |
| License | `NONE` |
| Stars | 1,447 (checked 2026-09-21) |
| Forks | 278 |
| Open issues | 43 |
| Contributors | 14 |
| Last push | 2025-12-24 (270 days before verification) |
...
No push in 270 days (>120d). Treat as maintenance mode: usable, but check for a recommended successor before adopting. NO LICENSE FILE DETECTED by GitHub. Copyright defaults to all-rights-reserved: do not vendor, copy or redistribute code from this repository. Reference and link only.
