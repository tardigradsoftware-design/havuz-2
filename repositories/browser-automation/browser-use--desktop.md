...
sources:
  - title: "browser-use/desktop on GitHub"
...
| Archived | no |
| Fork | no |
| Homepage | [http://browser-use.com/](http://browser-use.com/) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug browser-use/desktop
