...
- [alumnium-hq/alumnium](./alumnium-hq--alumnium.md) — tier S, ACTIVE
- [anthropics/claude-quickstarts](./anthropics--claude-quickstarts.md) — tier A, ACTIVE
- [arcboxlabs/arcbox](./arcboxlabs--arcbox.md) — tier S, ACTIVE
- [browser-use/browser-harness](./browser-use--browser-harness.md) — tier S, ACTIVE
- [browser-use/browser-use](./browser-use--browser-use.md) — tier S, ACTIVE
- [browser-use/desktop](./browser-use--desktop.md) — tier A, STABLE
- [browserbase/stagehand](./browserbase--stagehand.md) — tier S, ACTIVE
- [bytedance/UI-TARS-desktop](./bytedance--ui-tars-desktop.md) — tier A, ACTIVE
- [CelestoAI/celesto](./celestoai--celesto.md) — tier S, ACTIVE
- [D4Vinci/Scrapling](./d4vinci--scrapling.md) — tier S, ACTIVE
- [feder-cr/AIHawk](./feder-cr--aihawk.md) — tier A, ACTIVE
- [google-gemini/computer-use-preview](./google-gemini--computer-use-preview.md) — tier B, STABLE
- [lavague-ai/LaVague](./lavague-ai--lavague.md) — tier B, ABANDONED
- [microsoft/fara](./microsoft--fara.md) — tier A, STABLE
...
- [web-infra-dev/midscene](./web-infra-dev--midscene.md) — tier A, ACTIVE
