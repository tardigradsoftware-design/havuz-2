...
tags: ["agent", "browser", "browser-automation", "github-repository"]
version: 1.0.0
updated: 2026-09-16
...
sources:
  - title: "oxylabs/browser-agent-py on GitHub"
...
|---|---|
| URL | <https://github.com/oxylabs/browser-agent-py> |
| Owner | oxylabs (Organization) |
| Official upstream | no |
| Language | — |
| License | `NONE` |
| Stars | 1,565 (checked 2026-09-15) |
| Forks | 2 |
| Open issues | 0 |
| Contributors | 2 |
...
No push in 166 days (>120d). Treat as maintenance mode: usable, but check for a recommended successor before adopting. NO LICENSE FILE DETECTED by GitHub. Copyright defaults to all-rights-reserved: do not vendor, copy or redistribute code from this repository. Reference and link only.

## How to re-verify

```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug oxylabs/browser-agent-py
