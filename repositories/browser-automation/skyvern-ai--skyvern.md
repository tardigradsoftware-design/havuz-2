...
sources:
  - title: "Skyvern-AI/skyvern on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug Skyvern-AI/skyvern
