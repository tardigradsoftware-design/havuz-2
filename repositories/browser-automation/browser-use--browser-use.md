...
summary: >-
  ...
  115,673 stars, license MIT, quality 8.62/10, trust 8.51/10.
...
scoring:
  components: {"authority": 9.0, "maintenance": 10.0, "adoption": 10.0, "documentation": 5.75, "reproducibility": 10.0, "security": 4.5, "recency": 9.97, "evidence": 8.0}
  quality_score: 8.62
  trust_score: 8.51
  tier: S
...
| Language | Python |
| License | `MIT` |
| Stars | 115,673 (checked 2026-09-21) |
| Forks | 12,727 |
| Open issues | 463 |
| Contributors | 361 |
