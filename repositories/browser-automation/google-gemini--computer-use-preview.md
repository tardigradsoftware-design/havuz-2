---
id: google-gemini--computer-use-preview
...
sources:
  - title: "google-gemini/computer-use-preview on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug google-gemini/computer-use-preview
