...
sources:
  - title: "openinterpreter/openinterpreter on GitHub"
...
|---|---|
| URL | <https://github.com/openinterpreter/openinterpreter> |
| Owner | openinterpreter (Organization) |
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug openinterpreter/openinterpreter
