...
sources:
  - title: "CelestoAI/celesto on GitHub"
    url: https://github.com/CelestoAI/celesto
    type: github-repository
    organization: CelestoAI
    license: Apache-2.0
    license_risk: none
    confidence: very-high
    claim_type: fact
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug CelestoAI/celesto
