---
id: microsoft--playwright-python
...
sources:
  - title: "microsoft/playwright-python on GitHub"
...
```bash
GITHUB_TOKEN=*** python3 scripts/update/fetch_github_metadata.py --slug microsoft/playwright-python
