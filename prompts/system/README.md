...
System prompts: role and contract definitions for agents, written from scratch. Leaked or extracted vendor system prompts are never stored here — see the exclusion policy.
