...
Short, sharp traps: a specific thing that behaves contrary to expectation, with the correct behaviour stated. One gotcha per file, kept brief enough to scan.
