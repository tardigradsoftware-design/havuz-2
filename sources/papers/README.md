...
Paper source records beyond the verified set in metadata/sources-papers.json. Every paper here has been reached at its primary source; unverified candidates stay quarantined in metadata/pending-paper-candidates.json.
...
- [`metadata/sources-papers.json`](../../metadata/sources-papers.json)
