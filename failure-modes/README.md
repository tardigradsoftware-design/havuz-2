...
Named, reusable failure-mode records: what breaks, how it presents, how to detect it and how to recover. Distinct from anti-patterns, which are decisions; a failure mode is an observed behaviour.
...
- [`skills/root-cause-analysis/SKILL.md`](../skills/root-cause-analysis/SKILL.md)
