...
Agent evaluation suites: task sets, scoring rubrics and results for evaluating agent behaviour end to end.
...
- [`skills/ai-safety-evaluation/SKILL.md`](../../skills/ai-safety-evaluation/SKILL.md)
