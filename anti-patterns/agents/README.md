...
Agent anti-patterns: the ways agent designs fail — unbounded loops, silent context loss, permission creep, handoff ambiguity. Each record names the failure, why it is attractive, and the correction.
