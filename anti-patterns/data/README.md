...
Data anti-patterns: pipeline, validation and lineage mistakes — including the commonest one, treating a transformation as verified because it ran.
...
- [`skills/data-pipeline/SKILL.md`](../../skills/data-pipeline/SKILL.md)
