...
Completed research: reports that informed a decision, kept with their evidence set so the decision can be re-examined later. Distinct from knowledge/, which holds the durable conclusions.
...
- [`workflows/deep-research/WORKFLOW.md`](../workflows/deep-research/WORKFLOW.md)
